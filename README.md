...
### Ubuntu Linux / WSL (Windows 10)
    ...
    apt-get install build-essential git ninja-build cmake automake pkgconf libtool libtool-bin clang llvm lld libc++1 libc++abi1 libgmp-dev libmpfr-dev libmpc-dev libgcrypt-dev libmimalloc-dev python3-pip unzip p7zip-full curl ccache gettext autopoint nasm
